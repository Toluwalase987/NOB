...
export default function Zobo() {
  ...
  useEffect(() => {
    ...
    const imageUrls = [zobo1, zobo2, zobo3, zobo6, zobo7];
          ...
          <div className="column1">
            ...
            <div className="column1-right">
              ...
              <p>
                ...
                Is Our Local Beverage With The Popular Hibiscus Signature Taste.
                This Drink Has A Sure Refreshing Taste Like None Other.Impress
                With Style When You Refresh With Zobo!
              </p>
              <h4>Brand: Dovel</h4>
              {/* <hr /> */}
              <div className="price">
