...
export default function Bigi() {
  ...
  useEffect(() => {
    ...
    const imageUrls = [bigicola, bigiapple, bigilemon, bigitropical, bigiginger];
        ...
        <div className="drinks">
          <div className="column1">
            ...
            <div className="column1-right">
              <h2>Bigi Cola</h2>
              <p>
                Mouthwatering Perfection Starts With Originality In Taste. Bigi
                Cola Is Our Carbonated Drink With The Popular Cola Signature
                Taste. This Cola Drink Has A Sure Refreshing Taste Like None
                Other.Impress With Style When You Refresh With Mr. Cool!
              </p>
              <h4>Brand: Bigi</h4>
              {/* <hr /> */}
              <div className="price">
          ...
          <div className="column2">
            ...
            <div className="delivery-details">
              ...
              <div className="delivery-text">
                ...
                <p>
                  Ready for delivery between 24 October & 25 October when you
                  order within next 5hrs 12mins.
                </p>
              </div>
            </div>
            <div className="delivery-details">
              ...
              <div className="delivery-text">
                ...
                <p>
                  Arriving at pickup station between 24 October & 25 October
                  when you order within next 5hrs 12mins.
                </p>
              </div>
            </div>
          </div>
